...
(custom-theme-set-faces
 ...
 '(default                             ((t (:foreground "grey30"       :background "#ECE8E1"          :height 90   :inherit (fixed-pitch)            ))))
 ...
 '(mode-line                           ((t (:foreground "grey10"       :background "grey50"  :box nil :height 90    :inherit (variable-pitch)         ))))
